...
const WorkshopGallery = lazy(() => import("./pages/workshop/WorkshopGallery"));
...
const App = () => (
  <Router>
    <ScrollToTop>
      ...
      >
        <Routes>
          <Route path={process.env.PUBLIC_URL + "/"} element={<HomeHandmade />} />
          {/* Homepages */}
          ...
          <Route path={process.env.PUBLIC_URL + "/home-electronics-three"} element={<HomeElectronicsThree />} />
          ...
          <Route path={process.env.PUBLIC_URL + "/home-organic-food-two"} element={<HomeOrganicFoodTwo />} />
          ...
          <Route path={process.env.PUBLIC_URL + "/home-medical-equipment"} element={<HomeMedicalEquipment />} />
          ...
          <Route path={process.env.PUBLIC_URL + "/home-black-friday-two"} element={<HomeBlackFridayTwo />} />
          ...
          <Route path={process.env.PUBLIC_URL + "/order-history"} element={<OrderHistory />} />
          <Route path={process.env.PUBLIC_URL + "/support-policy"} element={<SupportPolicy />} />
          <Route path={process.env.PUBLIC_URL + "/size-guide"} element={<SizeGuide />} />
          <Route path={process.env.PUBLIC_URL + "/faq"} element={<Faq />} />
          <Route path={process.env.PUBLIC_URL + "/workshop-gallery"} element={<WorkshopGallery />} />
